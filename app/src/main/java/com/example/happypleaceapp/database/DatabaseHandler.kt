...
class DatabaseHandler(context: Context) :
    ...
    companion object {
        ...
        private const val TABLE_HAPPY_PLEACE = "HappyPlacesTable"
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        val CREATE_HAPPY_PLACE_TABLE = ("CREATE TABLE " + TABLE_HAPPY_PLEACE + "("
    ...
    override fun onUpgrade(db: SQLiteDatabase?, oldVersion: Int, newVersion: Int) {
        db!!.execSQL("DROP TABLE IF EXISTS $TABLE_HAPPY_PLEACE")
        onCreate(db)
    }
    ...
    fun addHappyPlace(happyPlace: HappyPlacesModel): Long {
        ...
        val result = db.insert(TABLE_HAPPY_PLEACE, null, contentValues)
        db.close()
        return result
    }
    ...
    fun updateHappyPlace(happyPlace: HappyPlacesModel): Int {
        ...
        val success =
            db.update(TABLE_HAPPY_PLEACE, contentValues, KEY_ID + "=" + happyPlace.id, null)
        db.close()
        return success
    }
    ...
    fun deleteHappyPlace(happyPlace: HappyPlacesModel): Int {
        val db = this.writableDatabase
        val success = db.delete(TABLE_HAPPY_PLEACE, KEY_ID + "=" + happyPlace.id, null)
        db.close()
        return success
    }
    ...
    fun getHappyPlaceList(): ArrayList<HappyPlacesModel> {
        ...
        val selectQuery = "SELECT * FROM $TABLE_HAPPY_PLEACE"
